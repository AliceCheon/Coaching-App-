...
.coach-editor-weekly .coach-editor-layout.unified { display:grid; min-width:0; }
...
.coach-editor-weekly .coach-editor-layout.unified.reference-open { grid-template-columns:minmax(0,1fr) 270px!important; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open .coach-program-day-table table { min-width:690px!important; font-size:10px; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open col.col-exercise { width:150px; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open col.col-type { width:70px; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open col.col-sets { width:42px; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open col.col-reps { width:62px; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open col.col-rest { width:52px; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open col.col-load { width:65px; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open col.col-rpe,
.coach-editor-weekly .coach-editor-layout.unified.reference-open col.col-rir { width:38px; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open col.col-tut { width:50px; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open col.col-notes { width:65px; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open col.col-actions { width:58px; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open .coach-program-day-table thead th { padding:5px 3px; font-size:8px; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open .coach-inline-exercise td { height:48px; padding:3px; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open .coach-inline-exercise input,
.coach-editor-weekly .coach-editor-layout.unified.reference-open .coach-inline-exercise select { height:30px; padding:3px 4px; font-size:10px; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open .coach-inline-sub { display:none; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open .coach-inline-actions { gap:2px; }
.coach-editor-weekly .coach-editor-layout.unified.reference-open .coach-inline-actions button,
.coach-editor-weekly .coach-editor-layout.unified.reference-open .coach-inline-actions summary { min-width:22px; min-height:24px; padding:2px; font-size:10px; }
...
.coach-editor-weekly .coach-row-more > div { max-height:min(420px,calc(100vh - 120px)); overflow:auto; overscroll-behavior:contain; }
.coach-editor-weekly .coach-inline-actions .progression-badge { max-width:170px; }
@media (prefers-reduced-motion: reduce) { .coach-editor-weekly *, .coach-editor-weekly *::before, .coach-editor-weekly *::after { scroll-behavior:auto !important; animation-duration:.001ms !important; transition-duration:.001ms !important; } }
