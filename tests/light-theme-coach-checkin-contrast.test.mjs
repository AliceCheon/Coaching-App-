...
if (!html.includes('sessionStorage.getItem("atlas-v91-reload")')) throw new Error("ricarica PWA v91 mancante");

console.log(JSON.stringify({ ok:true, coachContrast:true, checkinContrast:true, mascot:true, cache:"v91" }));
