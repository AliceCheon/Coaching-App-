...
const checks = [
  ...
  [html.includes("coach-schede-restyle-v146.css?v=v14754"), "cache bust CSS c10 mancante"],
  [sw.includes('const CACHE_NAME = "atlas-app-v14754-motore-fasi"'), "cache PWA c10 mancante"]
];
