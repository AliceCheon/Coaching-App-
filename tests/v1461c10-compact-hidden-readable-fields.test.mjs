...
const checks = [
  ...
  [html.includes("coach-schede-restyle-v146.css?v=v14761"), "cache bust CSS c10 mancante"],
  [sw.includes('const CACHE_NAME = "atlas-app-v14761-canvas-no-fixed-bg"'), "cache PWA c10 mancante"]
];
