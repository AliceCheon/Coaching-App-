...
const checks = [
  ...
  [html.includes("coach-schede-restyle-v146.css?v=v14755"), "cache bust CSS c10 mancante"],
  [sw.includes('const CACHE_NAME = "atlas-app-v14755-blocco-settimana"'), "cache PWA c10 mancante"]
];
