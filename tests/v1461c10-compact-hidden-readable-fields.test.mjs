...
const checks = [
  ...
  [html.includes("coach-schede-restyle-v146.css?v=v14751"), "cache bust CSS c10 mancante"],
  [sw.includes('const CACHE_NAME = "atlas-app-v14751-scheda-prima-fase-derivata"'), "cache PWA c10 mancante"]
];
