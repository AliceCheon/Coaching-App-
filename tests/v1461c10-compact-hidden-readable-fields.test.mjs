...
const checks = [
  ...
  [html.includes("coach-schede-restyle-v146.css?v=v14762"), "cache bust CSS c10 mancante"],
  [sw.includes('const CACHE_NAME = "atlas-app-v14762-short-edges-fullscreen"'), "cache PWA c10 mancante"]
];
