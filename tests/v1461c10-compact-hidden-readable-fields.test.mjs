...
const checks = [
  ...
  [html.includes("coach-schede-restyle-v146.css?v=v14758"), "cache bust CSS c10 mancante"],
  [sw.includes('const CACHE_NAME = "atlas-app-v14758-workout-context"'), "cache PWA c10 mancante"]
];
