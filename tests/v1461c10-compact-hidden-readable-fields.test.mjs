...
const checks = [
  ...
  [html.includes("coach-schede-restyle-v146.css?v=v14757"), "cache bust CSS c10 mancante"],
  [sw.includes('const CACHE_NAME = "atlas-app-v14757-canvas-not-white"'), "cache PWA c10 mancante"]
];
