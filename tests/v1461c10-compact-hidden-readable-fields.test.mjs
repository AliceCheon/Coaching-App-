...
const checks = [
  ...
  [html.includes("coach-schede-restyle-v146.css?v=v14756"), "cache bust CSS c10 mancante"],
  [sw.includes('const CACHE_NAME = "atlas-app-v14756-flexwindow-fullbleed"'), "cache PWA c10 mancante"]
];
