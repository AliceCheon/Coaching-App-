...
const checks = [
  ...
  [html.includes("coach-schede-restyle-v146.css?v=v14760"), "cache bust CSS c10 mancante"],
  [sw.includes('const CACHE_NAME = "atlas-app-v14760-cutout-edge-to-edge"'), "cache PWA c10 mancante"]
];
