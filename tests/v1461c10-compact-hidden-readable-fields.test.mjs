...
const checks = [
  ...
  [html.includes("coach-schede-restyle-v146.css?v=v14753"), "cache bust CSS c10 mancante"],
  [sw.includes('const CACHE_NAME = "atlas-app-v14753-fase-in-fondo"'), "cache PWA c10 mancante"]
];
