...
const checks = [
  ...
  [html.includes("coach-schede-restyle-v146.css?v=v14752"), "cache bust CSS c10 mancante"],
  [sw.includes('const CACHE_NAME = "atlas-app-v14752-fase-da-dati-programma"'), "cache PWA c10 mancante"]
];
