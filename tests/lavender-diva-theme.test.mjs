...
if (!sw.includes('CACHE_NAME = "atlas-app-v91"')) throw new Error("cache PWA non aggiornata");
...
console.log(JSON.stringify({ ok:true, themes:["lavender-diva","midnight-diva"], toggle:true, battery:false, mobile:true, workoutView:"tabs-compact", cache:"v91" }));
