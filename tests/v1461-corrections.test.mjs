...
check(config.includes('build: "v147.17-timeouts"'), "build v147.1 mancante");
check(config.includes('cache: "atlas-app-v14717-timeouts"'), "cache contrasto v147.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v14717-timeouts"'), "service worker contrasto non aggiornato");
