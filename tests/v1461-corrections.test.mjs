...
check(config.includes('cache: "atlas-app-v1461c8"'), "cache contrasto v146.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v1461c8"'), "service worker contrasto non aggiornato");
...
check(manifest.includes("index.html?v=v1461c8"), "manifest contrasto non aggiornato");
check(html.includes("coach-schede-restyle-v146.css?v=v1461c8"), "CSS senza cache bust contrasto");
check(html.includes("coach-schede-v146-enhance.js?v=v1461c8"), "JS senza cache bust v146.1");
