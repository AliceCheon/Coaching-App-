...
check(config.includes('build: "v147.55-blocco-settimana"'), "build v147.1 mancante");
check(config.includes('cache: "atlas-app-v14755-blocco-settimana"'), "cache contrasto v147.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v14755-blocco-settimana"'), "service worker contrasto non aggiornato");
...
check(manifest.includes("index.html?v=v14755"), "manifest contrasto non aggiornato");
check(html.includes("coach-schede-restyle-v146.css?v=v14755"), "CSS senza cache bust contrasto");
check(html.includes("coach-schede-v146-enhance.js?v=v14755"), "JS senza cache bust v146.1");
