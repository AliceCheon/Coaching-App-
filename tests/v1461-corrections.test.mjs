...
check(config.includes('build: "v147.53-fase-in-fondo"'), "build v147.1 mancante");
check(config.includes('cache: "atlas-app-v14753-fase-in-fondo"'), "cache contrasto v147.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v14753-fase-in-fondo"'), "service worker contrasto non aggiornato");
...
check(manifest.includes("index.html?v=v14753"), "manifest contrasto non aggiornato");
check(html.includes("coach-schede-restyle-v146.css?v=v14753"), "CSS senza cache bust contrasto");
check(html.includes("coach-schede-v146-enhance.js?v=v14753"), "JS senza cache bust v146.1");
