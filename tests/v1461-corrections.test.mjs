...
check(config.includes('build: "v147.10-storage-fix"'), "build v147.1 mancante");
check(config.includes('cache: "atlas-app-v14710-storage-fix"'), "cache contrasto v147.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v14710-storage-fix"'), "service worker contrasto non aggiornato");
...
check(manifest.includes("index.html?v=v14710"), "manifest contrasto non aggiornato");
