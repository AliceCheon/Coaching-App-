...
check(config.includes('build: "v147.54-motore-fasi"'), "build v147.1 mancante");
check(config.includes('cache: "atlas-app-v14754-motore-fasi"'), "cache contrasto v147.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v14754-motore-fasi"'), "service worker contrasto non aggiornato");
...
check(manifest.includes("index.html?v=v14754"), "manifest contrasto non aggiornato");
check(html.includes("coach-schede-restyle-v146.css?v=v14754"), "CSS senza cache bust contrasto");
check(html.includes("coach-schede-v146-enhance.js?v=v14754"), "JS senza cache bust v146.1");
