...
check(config.includes('build: "v147.9-boot-tdz-fix"'), "build v147.1 mancante");
check(config.includes('cache: "atlas-app-v1479-boot-tdz-fix"'), "cache contrasto v147.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v1479-boot-tdz-fix"'), "service worker contrasto non aggiornato");
...
check(manifest.includes("index.html?v=v1479"), "manifest contrasto non aggiornato");
