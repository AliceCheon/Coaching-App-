...
check(config.includes('build: "v147.50-fase-scheda-label"'), "build v147.1 mancante");
check(config.includes('cache: "atlas-app-v14750-fase-scheda-label"'), "cache contrasto v147.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v14750-fase-scheda-label"'), "service worker contrasto non aggiornato");
...
check(manifest.includes("index.html?v=v14750"), "manifest contrasto non aggiornato");
check(html.includes("coach-schede-restyle-v146.css?v=v14750"), "CSS senza cache bust contrasto");
check(html.includes("coach-schede-v146-enhance.js?v=v14750"), "JS senza cache bust v146.1");
