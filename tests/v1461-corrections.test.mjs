...
check(config.includes('build: "v147.44-coach-ai-sync"'), "build v147.1 mancante");
check(config.includes('cache: "atlas-app-v14744-coach-ai-sync"'), "cache contrasto v147.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v14744-coach-ai-sync"'), "service worker contrasto non aggiornato");
...
check(manifest.includes("index.html?v=v14744"), "manifest contrasto non aggiornato");
check(html.includes("coach-schede-restyle-v146.css?v=v14744"), "CSS senza cache bust contrasto");
check(html.includes("coach-schede-v146-enhance.js?v=v14744"), "JS senza cache bust v146.1");
