...
check(config.includes('build: "v147.15-sync-unlock"'), "build v147.1 mancante");
check(config.includes('cache: "atlas-app-v14715-sync-unlock"'), "cache contrasto v147.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v14715-sync-unlock"'), "service worker contrasto non aggiornato");
...
check(manifest.includes("index.html?v=v14715"), "manifest contrasto non aggiornato");
