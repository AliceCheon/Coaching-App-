...
check(config.includes('build: "v147.16-longpoll"'), "build v147.1 mancante");
check(config.includes('cache: "atlas-app-v14716-longpoll"'), "cache contrasto v147.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v14716-longpoll"'), "service worker contrasto non aggiornato");
