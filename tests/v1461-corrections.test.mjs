...
check(config.includes('build: "v147.13-sanitize-firestore"'), "build v147.1 mancante");
check(config.includes('cache: "atlas-app-v14713-sanitize-firestore"'), "cache contrasto v147.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v14713-sanitize-firestore"'), "service worker contrasto non aggiornato");
...
check(manifest.includes("index.html?v=v14713"), "manifest contrasto non aggiornato");
