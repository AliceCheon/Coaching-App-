...
check(config.includes('build: "v147.61-canvas-no-fixed-bg"'), "build v147.1 mancante");
check(config.includes('cache: "atlas-app-v14761-canvas-no-fixed-bg"'), "cache contrasto v147.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v14761-canvas-no-fixed-bg"'), "service worker contrasto non aggiornato");
...
check(manifest.includes("index.html?v=v14761"), "manifest contrasto non aggiornato");
check(html.includes("coach-schede-restyle-v146.css?v=v14761"), "CSS senza cache bust contrasto");
check(html.includes("coach-schede-v146-enhance.js?v=v14761"), "JS senza cache bust v146.1");
