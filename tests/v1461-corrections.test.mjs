...
check(config.includes('build: "v147.52-fase-da-dati-programma"'), "build v147.1 mancante");
check(config.includes('cache: "atlas-app-v14752-fase-da-dati-programma"'), "cache contrasto v147.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v14752-fase-da-dati-programma"'), "service worker contrasto non aggiornato");
...
check(manifest.includes("index.html?v=v14752"), "manifest contrasto non aggiornato");
check(html.includes("coach-schede-restyle-v146.css?v=v14752"), "CSS senza cache bust contrasto");
check(html.includes("coach-schede-v146-enhance.js?v=v14752"), "JS senza cache bust v146.1");
