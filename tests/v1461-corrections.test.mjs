...
check(config.includes('build: "v147.8-editor-cache-fix"'), "build v147.1 mancante");
check(config.includes('cache: "atlas-app-v1478-editor-cache-fix"'), "cache contrasto v147.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v1478-editor-cache-fix"'), "service worker contrasto non aggiornato");
...
check(manifest.includes("index.html?v=v1478"), "manifest contrasto non aggiornato");
