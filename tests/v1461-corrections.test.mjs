...
check(config.includes('build: "v147.19-cleanup"'), "build v147.1 mancante");
check(config.includes('cache: "atlas-app-v14719-cleanup"'), "cache contrasto v147.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v14719-cleanup"'), "service worker contrasto non aggiornato");
