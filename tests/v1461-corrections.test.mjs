...
check(config.includes('build: "v147.14-syntax-fix"'), "build v147.1 mancante");
check(config.includes('cache: "atlas-app-v14714-syntax-fix"'), "cache contrasto v147.1 mancante");
check(sw.includes('const CACHE_NAME = "atlas-app-v14714-syntax-fix"'), "service worker contrasto non aggiornato");
...
check(manifest.includes("index.html?v=v14714"), "manifest contrasto non aggiornato");
