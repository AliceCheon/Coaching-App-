...
check(config.includes('build: "v147.53-fase-in-fondo"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14753-fase-in-fondo"'), "La cache PWA non è allineata alla build v147.1.");
