...
check(config.includes('build: "v147.21-sync-boot-persist"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14721-sync-boot-persist"'), "La cache PWA non è allineata alla build v147.1.");
