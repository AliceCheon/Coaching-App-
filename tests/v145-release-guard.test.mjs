...
check(config.includes('build: "v147.14-syntax-fix"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14714-syntax-fix"'), "La cache PWA non è allineata alla build v147.1.");
