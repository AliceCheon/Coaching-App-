...
check(config.includes('build: "v147.55-blocco-settimana"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14755-blocco-settimana"'), "La cache PWA non è allineata alla build v147.1.");
