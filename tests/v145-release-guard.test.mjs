...
check(config.includes('build: "v147.54-motore-fasi"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14754-motore-fasi"'), "La cache PWA non è allineata alla build v147.1.");
