...
check(config.includes('build: "v147.56-flexwindow-fullbleed"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14756-flexwindow-fullbleed"'), "La cache PWA non è allineata alla build v147.1.");
