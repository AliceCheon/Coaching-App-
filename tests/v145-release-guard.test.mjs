...
check(config.includes('build: "v147.59-edge-to-edge"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14759-edge-to-edge"'), "La cache PWA non è allineata alla build v147.1.");
