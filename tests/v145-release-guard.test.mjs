...
check(config.includes('build: "v147.38-nutrition-purge"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14738-nutrition-purge"'), "La cache PWA non è allineata alla build v147.1.");
