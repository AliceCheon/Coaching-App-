...
check(config.includes('build: "v147.57-canvas-not-white"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14757-canvas-not-white"'), "La cache PWA non è allineata alla build v147.1.");
