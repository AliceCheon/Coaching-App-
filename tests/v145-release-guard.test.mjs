...
check(config.includes('build: "v147.58-workout-context"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14758-workout-context"'), "La cache PWA non è allineata alla build v147.1.");
