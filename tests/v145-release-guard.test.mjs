...
check(config.includes('build: "v147.15-sync-unlock"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14715-sync-unlock"'), "La cache PWA non è allineata alla build v147.1.");
