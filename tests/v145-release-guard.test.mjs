...
check(config.includes('build: "v147.16-longpoll"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14716-longpoll"'), "La cache PWA non è allineata alla build v147.1.");
