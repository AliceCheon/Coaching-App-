...
check(config.includes('build: "v147.62-short-edges-fullscreen"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14762-short-edges-fullscreen"'), "La cache PWA non è allineata alla build v147.1.");
