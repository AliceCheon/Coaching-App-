...
check(config.includes('build: "v147.9-boot-tdz-fix"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v1479-boot-tdz-fix"'), "La cache PWA non è allineata alla build v147.1.");
