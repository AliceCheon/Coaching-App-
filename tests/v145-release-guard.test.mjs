...
check(config.includes('build: "v147.20-errlog"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14720-errlog"'), "La cache PWA non è allineata alla build v147.1.");
