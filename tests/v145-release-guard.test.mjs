...
check(config.includes('build: "v147.22-sync-pwa-forced"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14722-sync-pwa-forced"'), "La cache PWA non è allineata alla build v147.1.");
