...
check(config.includes('build: "v147.50-fase-scheda-label"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14750-fase-scheda-label"'), "La cache PWA non è allineata alla build v147.1.");
