...
check(config.includes('build: "v147.23-programs-per-sheet-fix"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14728-workout-mascot"'), "La cache PWA non è allineata alla build v147.1.");
