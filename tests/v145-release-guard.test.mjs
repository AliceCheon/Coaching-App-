...
check(config.includes('build: "v147.17-timeouts"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14717-timeouts"'), "La cache PWA non è allineata alla build v147.1.");
