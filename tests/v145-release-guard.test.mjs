...
check(config.includes('build: "v147.60-cutout-edge-to-edge"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14760-cutout-edge-to-edge"'), "La cache PWA non è allineata alla build v147.1.");
