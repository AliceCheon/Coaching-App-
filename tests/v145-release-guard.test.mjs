...
check(config.includes('build: "v147.19-cleanup"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14719-cleanup"'), "La cache PWA non è allineata alla build v147.1.");
