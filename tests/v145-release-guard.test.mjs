...
check(config.includes('build: "v147.44-coach-ai-sync"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14744-coach-ai-sync"'), "La cache PWA non è allineata alla build v147.1.");
