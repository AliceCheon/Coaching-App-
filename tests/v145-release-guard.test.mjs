...
check(config.includes('build: "v147.61-canvas-no-fixed-bg"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14761-canvas-no-fixed-bg"'), "La cache PWA non è allineata alla build v147.1.");
