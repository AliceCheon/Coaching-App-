...
check(config.includes('build: "v147.13-sanitize-firestore"'), "La build non corrisponde alla v147.1.");
check(serviceWorker.includes('const CACHE_NAME = "atlas-app-v14713-sanitize-firestore"'), "La cache PWA non è allineata alla build v147.1.");
