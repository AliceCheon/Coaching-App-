...
if (!appMain.includes('window.matchMedia?.("(min-width: 981px)")') && !appMain.includes('window.matchMedia("(min-width: 981px)")')) throw new Error("protezione interfaccia mobile rimossa");
