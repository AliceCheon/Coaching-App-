...
if (!(html + inlineCss + appMain).includes("@media (prefers-reduced-motion: reduce)")) throw new Error("prefers-reduced-motion mancante");
if (!(html + inlineCss + appMain).includes("animation-duration:.01ms !important") || !(html + inlineCss + appMain).includes("transition-duration:.01ms !important")) throw new Error("riduzione animazioni incompleta");
if (!(html + inlineCss + appMain).includes("button:focus-visible")) throw new Error("focus visibile non garantito");
