...
check(config.includes('build: "v147.56-flexwindow-fullbleed"'), "build non aggiornata alla v147.22-sync-pwa-forced");
check(sw.includes("atlas-app-v14756-flexwindow-fullbleed"), "cache PWA non allineata alla v147.22-sync-pwa-forced");
