...
check(config.includes('build: "v147.57-canvas-not-white"'), "build non aggiornata alla v147.22-sync-pwa-forced");
check(sw.includes("atlas-app-v14757-canvas-not-white"), "cache PWA non allineata alla v147.22-sync-pwa-forced");
