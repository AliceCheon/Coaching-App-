...
check(config.includes('build: "v147.59-edge-to-edge"'), "build non aggiornata alla v147.22-sync-pwa-forced");
check(sw.includes("atlas-app-v14759-edge-to-edge"), "cache PWA non allineata alla v147.22-sync-pwa-forced");
