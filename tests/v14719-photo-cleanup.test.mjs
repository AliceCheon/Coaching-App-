...
check(config.includes('build: "v147.60-cutout-edge-to-edge"'), "build non aggiornata alla v147.22-sync-pwa-forced");
check(sw.includes("atlas-app-v14760-cutout-edge-to-edge"), "cache PWA non allineata alla v147.22-sync-pwa-forced");
