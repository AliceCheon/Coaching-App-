...
check(config.includes('build: "v147.38-nutrition-purge"'), "build non aggiornata alla v147.22-sync-pwa-forced");
check(sw.includes("atlas-app-v14738-nutrition-purge"), "cache PWA non allineata alla v147.22-sync-pwa-forced");
