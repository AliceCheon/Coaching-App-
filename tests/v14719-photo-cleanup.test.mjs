...
check(config.includes('build: "v147.58-workout-context"'), "build non aggiornata alla v147.22-sync-pwa-forced");
check(sw.includes("atlas-app-v14758-workout-context"), "cache PWA non allineata alla v147.22-sync-pwa-forced");
