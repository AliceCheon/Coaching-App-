...
check(config.includes('build: "v147.61-canvas-no-fixed-bg"'), "build non aggiornata alla v147.22-sync-pwa-forced");
check(sw.includes("atlas-app-v14761-canvas-no-fixed-bg"), "cache PWA non allineata alla v147.22-sync-pwa-forced");
