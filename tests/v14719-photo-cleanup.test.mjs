...
check(config.includes('build: "v147.50-fase-scheda-label"'), "build non aggiornata alla v147.22-sync-pwa-forced");
check(sw.includes("atlas-app-v14750-fase-scheda-label"), "cache PWA non allineata alla v147.22-sync-pwa-forced");
