...
check(config.includes('build: "v147.51-scheda-prima-fase-derivata"'), "build non aggiornata alla v147.22-sync-pwa-forced");
check(sw.includes("atlas-app-v14751-scheda-prima-fase-derivata"), "cache PWA non allineata alla v147.22-sync-pwa-forced");
