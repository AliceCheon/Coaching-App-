...
check(config.includes('build: "v147.53-fase-in-fondo"'), "build non aggiornata alla v147.22-sync-pwa-forced");
check(sw.includes("atlas-app-v14753-fase-in-fondo"), "cache PWA non allineata alla v147.22-sync-pwa-forced");
