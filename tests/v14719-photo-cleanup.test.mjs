...
check(config.includes('build: "v147.54-motore-fasi"'), "build non aggiornata alla v147.22-sync-pwa-forced");
check(sw.includes("atlas-app-v14754-motore-fasi"), "cache PWA non allineata alla v147.22-sync-pwa-forced");
