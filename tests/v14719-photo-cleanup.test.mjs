...
check(config.includes('build: "v147.55-blocco-settimana"'), "build non aggiornata alla v147.22-sync-pwa-forced");
check(sw.includes("atlas-app-v14755-blocco-settimana"), "cache PWA non allineata alla v147.22-sync-pwa-forced");
