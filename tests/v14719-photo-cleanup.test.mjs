...
check(config.includes('build: "v147.44-coach-ai-sync"'), "build non aggiornata alla v147.22-sync-pwa-forced");
check(sw.includes("atlas-app-v14744-coach-ai-sync"), "cache PWA non allineata alla v147.22-sync-pwa-forced");
