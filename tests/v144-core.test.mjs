...
check(config.includes('build: "v147.54-motore-fasi"') && config.includes('cache: "atlas-app-v14754-motore-fasi"'), "configurazione v147.1 non caricata correttamente");
check(sw.includes('const CACHE_NAME = "atlas-app-v14754-motore-fasi"'), "cache service worker non allineata alla build v147.1");
check(manifest.includes("index.html?v=v14754"), "manifest non allineato alla build v147.22-sync-pwa-forced");
