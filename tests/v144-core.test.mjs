...
check(config.includes('build: "v147.53-fase-in-fondo"') && config.includes('cache: "atlas-app-v14753-fase-in-fondo"'), "configurazione v147.1 non caricata correttamente");
check(sw.includes('const CACHE_NAME = "atlas-app-v14753-fase-in-fondo"'), "cache service worker non allineata alla build v147.1");
check(manifest.includes("index.html?v=v14753"), "manifest non allineato alla build v147.22-sync-pwa-forced");
