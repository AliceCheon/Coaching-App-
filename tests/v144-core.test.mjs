...
check(config.includes('build: "v147.51-scheda-fase-settimana"') && config.includes('cache: "atlas-app-v14751-scheda-fase-settimana"'), "configurazione v147.1 non caricata correttamente");
check(sw.includes('const CACHE_NAME = "atlas-app-v14751-scheda-fase-settimana"'), "cache service worker non allineata alla build v147.1");
