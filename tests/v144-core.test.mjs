...
check(config.includes('build: "v147.38-nutrition-purge"') && config.includes('cache: "atlas-app-v14738-nutrition-purge"'), "configurazione v147.1 non caricata correttamente");
check(sw.includes('const CACHE_NAME = "atlas-app-v14738-nutrition-purge"'), "cache service worker non allineata alla build v147.1");
